...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/FRAME_WORK/blob/main/20250717_221314.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/FRAME_WORK
    $ cd FRAME_WORK
    $ python S-H-Trix.py
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/FRAME_WORK && cd FRAME_WORK && python S-H-Trix.py
 ### Hi there 👋
